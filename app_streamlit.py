...
st.markdown("""
    ...
    .css-1d391kg, .stApp {background: linear-gradient(135deg,#f6f8fb 0%,#eef3ff 100%);} 
...
DEFAULT_PATH = r"d:\Trae_Projects\It5006\data_cleam（数据清洗）\Cleaned_Chicago_Crimes_2015_2024.csv"
